...
<cftry>
    ...
    <!--- Use all-zeros GUID for ad-hoc uploads and let SQL Server generate doc_uid with NEWID() --->
    ...
    <cftry>
        ...
        <!--- Get the generated doc_uid from OUTPUT clause --->
        ...
        <cfcatch type="database">
            ...
            <cfset data.db_insert_params = {
                "doc_uid": "NEWID() - generated by SQL Server",
